...
use crate::{
    ...
    schema::{OldTransactionInfoStorage, TransactionInfoStorage, TransactionStorage},
...
impl DBUpgrade {
    ...
    fn db_upgrade_v1_v2(instance: &mut StorageInstance) -> Result<()> {
        todo!()
        /*
            let old_transaction_info_storage = OldTransactionInfoStorage::new();
            let block_storage = BlockStorage::new(instance.clone());
            let block_info_storage = BlockInfoStorage::new(instance.clone());
            let transaction_info_storage = TransactionInfoStorage::new();
